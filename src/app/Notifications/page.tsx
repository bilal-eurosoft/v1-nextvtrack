      ...
      >
        <form className="form-material mt-4">
          ...
          <div>
            ...
            />
            <span className="text-green" style={{ fontSize: "23px" }}>
              {" "}
              Ignition On
            </span>
          ...
          <div>
            ...
            <span
              ...
              style={{ fontSize: "23px", paddingTop: "10px" }}
            >
              {" "}
              Ignition Off
            </span>
          ...
          <div>
            ...
            <div className="flex flex-wrap mb-4">
              <Card
                className={`w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 p-2 transition-all duration-300 ease-in-out transform hover:bg-gray-300 hover:shadow-2xl hover:scale-105 ${
                  !eventsp.targetEnteredZone
                    ? "opacity-50 cursor-not-allowed"
                    : "cursor-pointer" && !eventsp.targetLeftZone
                    ? "opacity-50 cursor-not-allowed"
                    : "cursor-pointer"
                }`}
              >
