...
import { getDocuments, handleServiceHistoryRequest, handleServicesRequest } from "@/utils/API_CALLS";
import { format } from 'date-fns'; // Import format from date-fns
import { VehicleData } from "@/types/servicehistory";
        ...
        console.log("id",id);
            ...
            const handleserviceChange = (field: 'expiryMilage' | 'reminderMilage' | 'lastMilage', mileage: number) => {
              ...
              const handleConfirmUpdate = async () => {
                console.log("Dvsv", serviceDataforupdate);
              const payload = {
