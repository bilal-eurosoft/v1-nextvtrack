...
const DynamicCarMap = ({
  ...
  return (
    <>
     {/*  <div className="xl:col-span-4 lg:col-span-3  md:col-span-3  sm:col-span-3 col-span-4 main_map" main_map2> */}
     <div className={`${fullparams == "full" ? "xl:col-span-4 lg:col-span-4  md:col-span-4  sm:col-span-4 col-span-4 main_map2" : "xl:col-span-4 lg:col-span-3  md:col-span-3  sm:col-span-3 col-span-4 main_map"}`}>
